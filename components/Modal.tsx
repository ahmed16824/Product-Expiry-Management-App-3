      ...
      >
        <div className={`flex justify-between items-center p-4 border-b border-slate-200 dark:border-slate-700 ${direction === 'rtl' ? 'text-right' : 'text-left'}`}>
          ...
          <button onClick={() => {
              playSound('click');
              onClose();
          }} className="text-slate-400 p-1 rounded-full hover:bg-slate-200 dark:hover:bg-slate-600 hover:text-slate-600 dark:hover:text-slate-300 transition-colors" aria-label="Close">
